...
const Hero = () => {
  ...
  return (
    <div className="h-[75vh] w-full border-b border-ui-border-base dark:border-neutral-700 relative bg-ui-bg-subtle dark:bg-neutral-900 transition-colors duration-200">
      <div className="absolute inset-0 z-10 flex flex-col justify-center items-center text-center small:p-32 gap-6">
        <img src={logoUrl} alt="Catalyst Pets Logo" className="h-24 w-auto mb-4" />
        <span>
          <Heading level="h1" className="text-3xl leading-10 text-ui-fg-base dark:text-neutral-100 font-normal">
            Welcome to Catalyst Pets!
          </Heading>
          <Heading level="h2" className="text-3xl leading-10 text-ui-fg-subtle dark:text-neutral-300 font-normal">
